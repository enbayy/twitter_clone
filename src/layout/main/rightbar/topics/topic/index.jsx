...
export default function Topic({ topic }) {
    return (
        ...
        >
            <div className="text-[13px] text-[#71767b] leading-4">{topic.title}</div>
            <div className="text-[15px] font-bold leading-5 mt-0.5">{topic.topic.type === 'tag' ? `#${topic.topic.value}` : topic.topic.value}</div>
            {topic?.postCount && (
